...
class PeminjamanController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('staff.peminjaman.create', compact('anggota', 'buku'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('staff.peminjaman.index')->with('success', 'Peminjaman berhasil dibuat.');
        } catch (\Exception $e) {
            DB::rollBack();
    ...
    public function edit(Peminjaman $peminjaman)
    {
        $anggota = Anggota::where('status', 'aktif')->get();
        $buku = Buku::all();
        return view('staff.peminjaman.edit', compact('peminjaman', 'anggota', 'buku'));
    }
    ...
    public function update(Request $request, Peminjaman $peminjaman)
    {
        ...
        return redirect()->route('staff.peminjaman.index')->with('success', 'Data peminjaman berhasil diperbarui.');
    }
    ...
    public function pengembalian(Request $request, Peminjaman $peminjaman)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('staff.peminjaman.index')->with('success', 'Buku berhasil dikembalikan.');
        } catch (\Exception $e) {
            DB::rollBack();
            return redirect()->back()->with('error', 'Terjadi kesalahan: ' . $e->getMessage());
        }
    ...
    public function perpanjang(Request $request, Peminjaman $peminjaman)
    {
        ...
        return redirect()->route('staff.peminjaman.index')->with('success', 'Peminjaman berhasil diperpanjang.');
    }
} 