...
class BukuController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('staff.buku.index', compact('buku', 'kategori'));
    }
    ...
    {
        $kategori = Kategori::all();
        return view('staff.buku.create', compact('kategori'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('staff.buku.index')
    ...
    {
        return view('staff.buku.show', compact('buku'));
    }
    ...
    {
        $kategori = Kategori::all();
        return view('staff.buku.edit', compact('buku', 'kategori'));
    }
    ...
    public function search(Request $request)
    {
        ...
        $results = $query->with('kategori')->paginate(10);
            
        return view('staff.buku.search', compact('results', 'kategori'));
    }
} 