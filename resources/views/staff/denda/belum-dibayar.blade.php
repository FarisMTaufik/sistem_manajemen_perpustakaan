        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <span>{{ __('Denda Belum Dibayar') }}</span>
                    <div>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <div class="btn-group" role="group">
                            ...
                            <a href="{{ route('staff.denda.belum-dibayar') }}" class="btn btn-primary">Belum Dibayar</a>
                            <a href="{{ route('staff.denda.sudah-dibayar') }}" class="btn btn-outline-primary">Sudah Dibayar</a>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                ...
                                                <form action="{{ route('staff.denda.bayar', $d->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                ...
                                @empty
                                    <tr>
                                        <td colspan="8" class="text-center">Tidak ada data denda yang belum dibayar.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
