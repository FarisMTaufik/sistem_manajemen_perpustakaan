        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="{{ route('staff.denda.riwayat-pembayaran') }}" class="btn btn-info btn-sm me-2">Riwayat Pembayaran</a>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <div class="btn-group" role="group">
                            <a href="{{ route('staff.denda.index') }}" class="btn btn-primary">Semua</a>
