        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('staff.buku.create') }}" class="btn btn-primary btn-sm">Tambah Buku</a>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        <form action="{{ route('staff.buku.index') }}" method="GET" class="row g-3">
                            <div class="col-md-4">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            <a href="{{ route('staff.buku.edit', $item->id) }}" class="btn btn-warning btn-sm">Edit</a>
                                        </div>
                                    </td>
                                </tr>
                                @empty
