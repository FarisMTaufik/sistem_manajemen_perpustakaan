        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('staff.anggota.create') }}" class="btn btn-primary btn-sm">Tambah Anggota</a>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        <form action="{{ route('staff.anggota.index') }}" method="GET" class="row g-3">
                            <div class="col-md-4">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('staff.anggota.show', $item) }}" class="btn btn-info btn-sm">Detail</a>
                                            <a href="{{ route('staff.anggota.edit', $item) }}" class="btn btn-warning btn-sm">Edit</a>
                                        </div>
                                    </td>
                                </tr>
                                @empty
