                    ...
                    @if ($peminjaman->denda)
                        <div class="row mb-4">
                            <div class="col-md-12">
                                ...
                                @if ($peminjaman->denda->status_pembayaran == 'belum_dibayar')
                                    <form action="{{ route('staff.denda.bayar', $peminjaman->denda->id) }}" method="POST" class="mt-3">
                                        @csrf
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="d-flex gap-2">
                                <a href="{{ route('staff.peminjaman.edit', $peminjaman->id) }}" class="btn btn-primary">Edit</a>
                                
                                @if ($peminjaman->status == 'dipinjam')
                                    <form action="{{ route('staff.peminjaman.pengembalian', $peminjaman->id) }}" method="POST">
                                        @csrf
                                    ...
                                    @if ($peminjaman->perpanjangan_count < 2)
                                        <form action="{{ route('staff.peminjaman.perpanjang', $peminjaman->id) }}" method="POST">
                                            @csrf
