                    ...
                    <form action="{{ route('anggota.katalog.search') }}" method="GET" class="row g-3">
                        <div class="col-md-6">
                            <div class="input-group">
                                <input type="text" name="keyword" class="form-control" placeholder="Cari judul, penulis, atau ISBN..." value="{{ $keyword }}">
    ...
    <div class="row mb-4">
        <div class="col-md-12">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div>
                    <span class="text-muted">Ditemukan {{ $buku->total() }} hasil</span>
                </div>
                <div>
                    <a href="{{ route('anggota.katalog.index') }}" class="btn btn-outline-secondary btn-sm">
    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="alert alert-info">
                <i class="fas fa-info-circle me-2"></i> Tidak ada buku yang ditemukan untuk kata kunci "{{ $keyword }}"
            </div>
            <div class="text-center mt-3">
                <a href="{{ route('anggota.katalog.index') }}" class="btn btn-primary">
                    <i class="fas fa-book me-1"></i> Lihat Semua Buku
                </a>
            </div>
        </div>
        @endforelse
